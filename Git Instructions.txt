Steps for Git creation:-


STEP:1 DOWNLOAD GIT LINK: https://git-scm.com/downloads

STEP: 2 CREATE ACCOUNT ON GIT HUB lINK: https://github.com/
...
d: +enter cd GITHUB +enter cd DEMO +enter

RUN THE BELOW COMMANDS ONE BY ONE
git init git branch -M main git remote add origin https://github.com/prathijnaudupa/JAVA-FSD-PHASE11.git git add . git commit -m "first commit"
...
git add . git commit -m "you msg" git push -u origin main